...
#         if x_mask is None:
#             x_mask = 1
#         embedding = self.prenet(x) * x_mask
#         x = self.res_conv_block(embedding, x_mask)
#         x = self.postnet1(x) * x_mask + embedding
#         return torch.transpose(self.postnet2(x) * x_mask, 1, -1)
