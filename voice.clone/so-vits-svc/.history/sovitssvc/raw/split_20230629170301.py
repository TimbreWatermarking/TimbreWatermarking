...
# Example usage
# split_audio("1_听妈妈de话_(Vocals)_9.900_257.700.wav")
# split_audio("1_林俊杰 - 杀手_(Vocals).wav")
# split_audio("1_Ta Bu Dong - AJ Zhang Jie_(Vocals).wav")
# split_audio("1_Michael-Jackson-We-Are-the-World-_Demo__(Vocals).wav")
split_audio("1_We-Are-The-Champions_(Vocals).wav")
